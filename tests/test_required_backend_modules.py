...
def test_admin_api_endpoints_exist(client):
    for path in ["/api/admin/status", "/api/admin/providers", "/api/admin/cache", "/api/admin/research-jobs", "/api/admin/agent-runs", "/api/admin/llm-usage", "/api/admin/cost", "/api/admin/errors", "/api/health/llm"]:
